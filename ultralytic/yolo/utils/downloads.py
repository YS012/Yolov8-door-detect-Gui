...
from ultralytic.yolo.utils import LOGGER, checks, clean_url, emojis, is_online, url2file
...
def attempt_download_asset(file, repo='ultralytics/assets', release='v0.0.0'):
    ...
    from ultralytic.yolo.utils import SETTINGS  # scoped for circular import
