...
from ultralytic.nn.tasks import (ClassificationModel, DetectionModel, PoseModel, SegmentationModel,
                                 attempt_load_one_weight, guess_model_task, nn, yaml_model_load)
from ultralytic.yolo.cfg import get_cfg
from ultralytic.yolo.engine.exporter import Exporter
from ultralytic.yolo.utils import (DEFAULT_CFG, DEFAULT_CFG_DICT, DEFAULT_CFG_KEYS, LOGGER, RANK, ROOT, callbacks,
                                   is_git_dir, yaml_load)
from ultralytic.yolo.utils.checks import check_file, check_imgsz, check_pip_update_available, check_yaml
...
class YOLO:
    ...
    def track(self, source=None, stream=False, persist=False, **kwargs):
        ...
        if not hasattr(self.predictor, 'trackers'):
            from ultralytic.tracker import register_tracker
    ...
    def benchmark(self, **kwargs):
        ...
        """
        self._check_is_pytorch_model()
        from ultralytic.yolo.utils.benchmarks import benchmark
